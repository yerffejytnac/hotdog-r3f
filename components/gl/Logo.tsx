...
export interface LogoProps extends React.ComponentProps<"group"> {
...
export const Logo = forwardRef<LogoRef, LogoProps>(function Logo(
  ...
  ref: ForwardedRef<LogoRef>,
) {
  const group = useRef<THREE.Group>(null);
  const { nodes, materials, animations } = useGLTF(
    "./assets/models/hotdog-v1-transformed.glb",
...
useGLTF.preload("./assets/models/hotdog-v1-transformed.glb");
